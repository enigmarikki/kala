...
pub mod tx {
    ...
    impl<'b> flatbuffers::Push for Bytes128 {
        ...
        unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
            let src = ::core::slice::from_raw_parts(
                self as *const Bytes128 as *const u8,
                <Self as flatbuffers::Push>::size(),
            );
            dst.copy_from_slice(src);
        }
    ...
    impl<'b> flatbuffers::Push for Nonce96 {
        ...
        unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
            let src = ::core::slice::from_raw_parts(
                self as *const Nonce96 as *const u8,
                <Self as flatbuffers::Push>::size(),
            );
            dst.copy_from_slice(src);
        }
    ...
    impl core::fmt::Debug for Tag128 {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("Tag128").field("mac", &self.mac()).finish()
        }
    }
    ...
    impl<'b> flatbuffers::Push for Tag128 {
        ...
        unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
            let src = ::core::slice::from_raw_parts(
                self as *const Tag128 as *const u8,
                <Self as flatbuffers::Push>::size(),
            );
            dst.copy_from_slice(src);
        }
