...
impl<'b> flatbuffers::Push for Bytes32 {
    ...
    #[inline]
    unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
        let src = ::core::slice::from_raw_parts(self as *const Bytes32 as *const u8, <Self as flatbuffers::Push>::size());
...
impl<'b> flatbuffers::Push for Bytes64 {
    ...
    #[inline]
    unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
        let src = ::core::slice::from_raw_parts(self as *const Bytes64 as *const u8, <Self as flatbuffers::Push>::size());
        dst.copy_from_slice(src);
    }
    #[inline]
    fn alignment() -> flatbuffers::PushAlignment {
...
impl core::fmt::Debug for Bytes128 {
  fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
    f.debug_struct("Bytes128")
      .field("data", &self.data())
      .finish()
  }
}

impl flatbuffers::SimpleToVerifyInSlice for Bytes128 {}
impl<'a> flatbuffers::Follow<'a> for Bytes128 {
  type Inner = &'a Bytes128;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    <&'a Bytes128>::follow(buf, loc)
  }
}
impl<'a> flatbuffers::Follow<'a> for &'a Bytes128 {
  type Inner = &'a Bytes128;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    flatbuffers::follow_cast_ref::<Bytes128>(buf, loc)
  }
}
impl<'b> flatbuffers::Push for Bytes128 {
    type Output = Bytes128;
    #[inline]
    unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
        let src = ::core::slice::from_raw_parts(self as *const Bytes128 as *const u8, <Self as flatbuffers::Push>::size());
        dst.copy_from_slice(src);
    }
    #[inline]
    fn alignment() -> flatbuffers::PushAlignment {
...
impl<'a> flatbuffers::Verifiable for Bytes128 {
  #[inline]
  fn run_verifier(
    v: &mut flatbuffers::Verifier, pos: usize
  ) -> Result<(), flatbuffers::InvalidFlatbuffer> {
...
impl<'a> Bytes128 {
  ...
  pub fn data(&'a self) -> flatbuffers::Array<'a, u8, 128> {
    // Safety:
    // Created from a valid Table for this object
    // Which contains a valid array in this slot
    unsafe { flatbuffers::Array::follow(&self.0, 0) }
  ...
  pub fn set_data(&mut self, items: &[u8; 128]) {
    // Safety:
    // Created from a valid Table for this object
    // Which contains a valid array in this slot
    unsafe { flatbuffers::emplace_scalar_array(&mut self.0, 0, items) };
...
impl<'b> flatbuffers::Push for Bytes256 {
    ...
    #[inline]
    unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
        let src = ::core::slice::from_raw_parts(self as *const Bytes256 as *const u8, <Self as flatbuffers::Push>::size());
        dst.copy_from_slice(src);
    }
    #[inline]
    fn alignment() -> flatbuffers::PushAlignment {
...
impl core::fmt::Debug for Nonce96 {
  fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
    f.debug_struct("Nonce96")
      .field("data", &self.data())
      .finish()
  }
}

impl flatbuffers::SimpleToVerifyInSlice for Nonce96 {}
impl<'a> flatbuffers::Follow<'a> for Nonce96 {
  type Inner = &'a Nonce96;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    <&'a Nonce96>::follow(buf, loc)
  }
}
impl<'a> flatbuffers::Follow<'a> for &'a Nonce96 {
  type Inner = &'a Nonce96;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    flatbuffers::follow_cast_ref::<Nonce96>(buf, loc)
  }
}
impl<'b> flatbuffers::Push for Nonce96 {
    type Output = Nonce96;
    #[inline]
    unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
        let src = ::core::slice::from_raw_parts(self as *const Nonce96 as *const u8, <Self as flatbuffers::Push>::size());
        dst.copy_from_slice(src);
    }
    #[inline]
    fn alignment() -> flatbuffers::PushAlignment {
...
impl<'a> flatbuffers::Verifiable for Nonce96 {
  #[inline]
  fn run_verifier(
    v: &mut flatbuffers::Verifier, pos: usize
  ) -> Result<(), flatbuffers::InvalidFlatbuffer> {
...
// struct Tag128, aligned to 1
#[repr(transparent)]
#[derive(Clone, Copy, PartialEq)]
pub struct Tag128(pub [u8; 16]);
impl Default for Tag128 { 
  fn default() -> Self { 
    Self([0; 16])
  }
}
impl core::fmt::Debug for Tag128 {
  fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
    f.debug_struct("Tag128")
      .field("mac", &self.mac())
      .finish()
  }
}

impl flatbuffers::SimpleToVerifyInSlice for Tag128 {}
impl<'a> flatbuffers::Follow<'a> for Tag128 {
  type Inner = &'a Tag128;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    <&'a Tag128>::follow(buf, loc)
  }
}
impl<'a> flatbuffers::Follow<'a> for &'a Tag128 {
  type Inner = &'a Tag128;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    flatbuffers::follow_cast_ref::<Tag128>(buf, loc)
  }
}
impl<'b> flatbuffers::Push for Tag128 {
    type Output = Tag128;
    #[inline]
    unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
        let src = ::core::slice::from_raw_parts(self as *const Tag128 as *const u8, <Self as flatbuffers::Push>::size());
        dst.copy_from_slice(src);
    }
    #[inline]
    fn alignment() -> flatbuffers::PushAlignment {
...
impl<'a> flatbuffers::Verifiable for Tag128 {
  #[inline]
  fn run_verifier(
    v: &mut flatbuffers::Verifier, pos: usize
  ) -> Result<(), flatbuffers::InvalidFlatbuffer> {
...
impl<'a> Tag128 {
  ...
  pub fn mac(&'a self) -> flatbuffers::Array<'a, u8, 16> {
    // Safety:
    // Created from a valid Table for this object
    // Which contains a valid array in this slot
    unsafe { flatbuffers::Array::follow(&self.0, 0) }
  ...
  pub fn set_mac(&mut self, items: &[u8; 16]) {
    // Safety:
    // Created from a valid Table for this object
    // Which contains a valid array in this slot
    unsafe { flatbuffers::emplace_scalar_array(&mut self.0, 0, items) };
...
impl<'a> SendTx<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.gas_sponsorer { builder.add_gas_sponsorer(x); }
  ...
  pub fn sender(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(SendTx::VT_SENDER, None)}
  }
  #[inline]
  pub fn receiver(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(SendTx::VT_RECEIVER, None)}
  }
  #[inline]
  pub fn denom(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(SendTx::VT_DENOM, None)}
  }
  #[inline]
  ...
  pub fn signature(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(SendTx::VT_SIGNATURE, None)}
  }
  #[inline]
  pub fn gas_sponsorer(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(SendTx::VT_GAS_SPONSORER, None)}
  }
}
...
impl flatbuffers::Verifiable for SendTx<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, u8>>>("receiver", Self::VT_RECEIVER, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, u8>>>("denom", Self::VT_DENOM, false)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, u8>>>("gas_sponsorer", Self::VT_GAS_SPONSORER, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> SendTxBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn add_receiver(&mut self, receiver: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
  ...
  pub fn add_signature(&mut self, signature: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(SendTx::VT_SIGNATURE, signature);
  }
  #[inline]
  pub fn add_gas_sponsorer(&mut self, gas_sponsorer: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(SendTx::VT_GAS_SPONSORER, gas_sponsorer);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> SendTxBuilder<'a, 'b, A> {
...
impl<'a> MintTx<'a> {
  ...
  pub fn sender(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(MintTx::VT_SENDER, None)}
  }
  #[inline]
  pub fn amount(&self) -> u64 {
    // Safety:
  ...
  pub fn denom(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(MintTx::VT_DENOM, None)}
  }
  #[inline]
  pub fn nonce(&self) -> u64 {
    // Safety:
  ...
  pub fn signature(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(MintTx::VT_SIGNATURE, None)}
  }
  #[inline]
  pub fn gas_sponsorer(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(MintTx::VT_GAS_SPONSORER, None)}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> MintTxBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn add_signature(&mut self, signature: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MintTx::VT_SIGNATURE, signature);
  }
  #[inline]
  pub fn add_gas_sponsorer(&mut self, gas_sponsorer: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(MintTx::VT_GAS_SPONSORER, gas_sponsorer);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> MintTxBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    MintTxBuilder {
      fbb_: _fbb,
      start_: start,
...
impl<'a> BurnTx<'a> {
  ...
  pub fn sender(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(BurnTx::VT_SENDER, None)}
  }
  #[inline]
  pub fn amount(&self) -> u64 {
    // Safety:
  ...
  pub fn denom(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(BurnTx::VT_DENOM, None)}
  }
  #[inline]
  pub fn nonce(&self) -> u64 {
    // Safety:
  ...
  pub fn signature(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(BurnTx::VT_SIGNATURE, None)}
  }
  #[inline]
  pub fn gas_sponsorer(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(BurnTx::VT_GAS_SPONSORER, None)}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> BurnTxBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn add_signature(&mut self, signature: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(BurnTx::VT_SIGNATURE, signature);
  }
  #[inline]
  pub fn add_gas_sponsorer(&mut self, gas_sponsorer: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(BurnTx::VT_GAS_SPONSORER, gas_sponsorer);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> BurnTxBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    BurnTxBuilder {
      fbb_: _fbb,
      start_: start,
...
impl<'a> StakeTx<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.delegator { builder.add_delegator(x); }
    builder.finish()
  }
  ...
  pub fn delegator(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(StakeTx::VT_DELEGATOR, None)}
  }
  #[inline]
  pub fn witness(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(StakeTx::VT_WITNESS, None)}
  }
  #[inline]
  pub fn amount(&self) -> u64 {
    // Safety:
  ...
  pub fn signature(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(StakeTx::VT_SIGNATURE, None)}
  }
  #[inline]
  pub fn gas_sponsorer(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(StakeTx::VT_GAS_SPONSORER, None)}
  }
}
...
impl flatbuffers::Verifiable for StakeTx<'_> {
  ...
  fn run_verifier(
    ...
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, u8>>>("delegator", Self::VT_DELEGATOR, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, u8>>>("witness", Self::VT_WITNESS, false)?
     .visit_field::<u64>("amount", Self::VT_AMOUNT, false)?
     .visit_field::<u64>("nonce", Self::VT_NONCE, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, u8>>>("signature", Self::VT_SIGNATURE, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, u8>>>("gas_sponsorer", Self::VT_GAS_SPONSORER, false)?
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> StakeTxBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_delegator(&mut self, delegator: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(StakeTx::VT_DELEGATOR, delegator);
  }
  #[inline]
  pub fn add_witness(&mut self, witness: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
  ...
  #[inline]
  pub fn add_signature(&mut self, signature: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(StakeTx::VT_SIGNATURE, signature);
  }
  #[inline]
  pub fn add_gas_sponsorer(&mut self, gas_sponsorer: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(StakeTx::VT_GAS_SPONSORER, gas_sponsorer);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> StakeTxBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    StakeTxBuilder {
      fbb_: _fbb,
      start_: start,
...
impl<'a> UnstakeTx<'a> {
  ...
  pub fn delegator(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(UnstakeTx::VT_DELEGATOR, None)}
  }
  #[inline]
  pub fn witness(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(UnstakeTx::VT_WITNESS, None)}
  }
  #[inline]
  pub fn amount(&self) -> u64 {
    // Safety:
  ...
  pub fn signature(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(UnstakeTx::VT_SIGNATURE, None)}
  }
  #[inline]
  pub fn gas_sponsorer(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(UnstakeTx::VT_GAS_SPONSORER, None)}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> UnstakeTxBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_delegator(&mut self, delegator: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(UnstakeTx::VT_DELEGATOR, delegator);
  }
  #[inline]
  pub fn add_witness(&mut self, witness: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
  ...
  #[inline]
  pub fn add_signature(&mut self, signature: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(UnstakeTx::VT_SIGNATURE, signature);
  }
  #[inline]
  pub fn add_gas_sponsorer(&mut self, gas_sponsorer: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(UnstakeTx::VT_GAS_SPONSORER, gas_sponsorer);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> UnstakeTxBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    UnstakeTxBuilder {
      fbb_: _fbb,
      start_: start,
...
impl<'a> SolveTx<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.gas_sponsorer { builder.add_gas_sponsorer(x); }
    if let Some(x) = args.signature { builder.add_signature(x); }
    if let Some(x) = args.puzzle_id { builder.add_puzzle_id(x); }
  ...
  pub fn sender(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(SolveTx::VT_SENDER, None)}
  }
  #[inline]
  pub fn proof(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(SolveTx::VT_PROOF, None)}
  }
  #[inline]
  pub fn puzzle_id(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(SolveTx::VT_PUZZLE_ID, None)}
  }
  #[inline]
  pub fn nonce(&self) -> u64 {
    // Safety:
  ...
  pub fn signature(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(SolveTx::VT_SIGNATURE, None)}
  }
  #[inline]
  pub fn gas_sponsorer(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(SolveTx::VT_GAS_SPONSORER, None)}
  }
}
...
impl flatbuffers::Verifiable for SolveTx<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, u8>>>("puzzle_id", Self::VT_PUZZLE_ID, false)?
     .visit_field::<u64>("nonce", Self::VT_NONCE, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, u8>>>("signature", Self::VT_SIGNATURE, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, u8>>>("gas_sponsorer", Self::VT_GAS_SPONSORER, false)?
     .finish();
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> SolveTxBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn add_puzzle_id(&mut self, puzzle_id: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(SolveTx::VT_PUZZLE_ID, puzzle_id);
  }
  #[inline]
  pub fn add_nonce(&mut self, nonce: u64) {
  ...
  #[inline]
  pub fn add_signature(&mut self, signature: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(SolveTx::VT_SIGNATURE, signature);
  }
  #[inline]
  pub fn add_gas_sponsorer(&mut self, gas_sponsorer: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(SolveTx::VT_GAS_SPONSORER, gas_sponsorer);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> SolveTxBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    SolveTxBuilder {
      fbb_: _fbb,
      start_: start,
...
impl<'a> Transaction<'a> {
  ...
  pub fn body_type(&self) -> TxBody {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<TxBody>(Transaction::VT_BODY_TYPE, Some(TxBody::NONE)).unwrap()}
  }
  #[inline]
  pub fn body(&self) -> Option<flatbuffers::Table<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Table<'a>>>(Transaction::VT_BODY, None)}
  }
  #[inline]
...
impl flatbuffers::Verifiable for Transaction<'_> {
  ...
  fn run_verifier(
    ...
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_union::<TxBody, _>("body_type", Self::VT_BODY_TYPE, "body", Self::VT_BODY, false, |key, v, pos| {
        match key {
          TxBody::SendTx => v.verify_union_variant::<flatbuffers::ForwardsUOffset<SendTx>>("TxBody::SendTx", pos),
          TxBody::MintTx => v.verify_union_variant::<flatbuffers::ForwardsUOffset<MintTx>>("TxBody::MintTx", pos),
          TxBody::BurnTx => v.verify_union_variant::<flatbuffers::ForwardsUOffset<BurnTx>>("TxBody::BurnTx", pos),
          TxBody::StakeTx => v.verify_union_variant::<flatbuffers::ForwardsUOffset<StakeTx>>("TxBody::StakeTx", pos),
          TxBody::UnstakeTx => v.verify_union_variant::<flatbuffers::ForwardsUOffset<UnstakeTx>>("TxBody::UnstakeTx", pos),
          TxBody::SolveTx => v.verify_union_variant::<flatbuffers::ForwardsUOffset<SolveTx>>("TxBody::SolveTx", pos),
          _ => Ok(()),
        }
     })?
     .finish();
...
impl<'a> SealedTx<'a> {
  ...
  pub fn nonce(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(SealedTx::VT_NONCE, None)}
  }
  #[inline]
  pub fn tag(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(SealedTx::VT_TAG, None)}
  }
  #[inline]
  pub fn ciphertext(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(SealedTx::VT_CIPHERTEXT, None)}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> SealedTxBuilder<'a, 'b, A> {
  ...
  pub fn add_ciphertext(&mut self, ciphertext: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(SealedTx::VT_CIPHERTEXT, ciphertext);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> SealedTxBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    SealedTxBuilder {
      fbb_: _fbb,
      start_: start,
