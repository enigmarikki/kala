...
impl<'a> StakeTx<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.gas_sponsorer { builder.add_gas_sponsorer(x); }
    if let Some(x) = args.signature { builder.add_signature(x); }
    if let Some(x) = args.delegation_receiver { builder.add_delegation_receiver(x); }
    if let Some(x) = args.sender { builder.add_sender(x); }
    builder.finish()
  }
  ...
  pub fn sender(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(StakeTx::VT_SENDER, None)}
  }
  #[inline]
  pub fn delegation_receiver(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(StakeTx::VT_DELEGATION_RECEIVER, None)}
  }
  #[inline]
  pub fn amount(&self) -> u64 {
    // Safety:
...
impl flatbuffers::Verifiable for StakeTx<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, u8>>>("sender", Self::VT_SENDER, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, u8>>>("delegation_receiver", Self::VT_DELEGATION_RECEIVER, false)?
     .visit_field::<u64>("amount", Self::VT_AMOUNT, false)?
     .visit_field::<u64>("nonce", Self::VT_NONCE, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, u8>>>("signature", Self::VT_SIGNATURE, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, u8>>>("gas_sponsorer", Self::VT_GAS_SPONSORER, false)?
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> StakeTxBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_sender(&mut self, sender: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(StakeTx::VT_SENDER, sender);
  }
  #[inline]
  pub fn add_delegation_receiver(&mut self, delegation_receiver: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(StakeTx::VT_DELEGATION_RECEIVER, delegation_receiver);
  }
  #[inline]
  pub fn add_amount(&mut self, amount: u64) {
