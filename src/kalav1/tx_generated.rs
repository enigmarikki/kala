...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> SendTxBuilder<'a, 'b, A> {
  ...
  pub fn add_sender(&mut self, sender: &Bytes32) {
    self.fbb_.push_slot_always::<&Bytes32>(SendTx::VT_SENDER, sender);
  }
  #[inline]
  pub fn add_receiver(&mut self, receiver: &Bytes32) {
    self.fbb_.push_slot_always::<&Bytes32>(SendTx::VT_RECEIVER, receiver);
  }
  #[inline]
  pub fn add_denom(&mut self, denom: &Bytes32) {
    self.fbb_.push_slot_always::<&Bytes32>(SendTx::VT_DENOM, denom);
  }
  #[inline]
  ...
  pub fn add_signature(&mut self, signature: &Bytes64) {
    self.fbb_.push_slot_always::<&Bytes64>(SendTx::VT_SIGNATURE, signature);
  }
  #[inline]
  pub fn add_gas_sponsorer(&mut self, gas_sponsorer: &Bytes32) {
    self.fbb_.push_slot_always::<&Bytes32>(SendTx::VT_GAS_SPONSORER, gas_sponsorer);
  }
  #[inline]
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> MintTxBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_sender(&mut self, sender: &Bytes32) {
    self.fbb_.push_slot_always::<&Bytes32>(MintTx::VT_SENDER, sender);
  }
  #[inline]
  pub fn add_amount(&mut self, amount: u64) {
  ...
  #[inline]
  pub fn add_denom(&mut self, denom: &Bytes32) {
    self.fbb_.push_slot_always::<&Bytes32>(MintTx::VT_DENOM, denom);
  }
  #[inline]
  pub fn add_nonce(&mut self, nonce: u64) {
  ...
  #[inline]
  pub fn add_signature(&mut self, signature: &Bytes64) {
    self.fbb_.push_slot_always::<&Bytes64>(MintTx::VT_SIGNATURE, signature);
  }
  #[inline]
  pub fn add_gas_sponsorer(&mut self, gas_sponsorer: &Bytes32) {
    self.fbb_.push_slot_always::<&Bytes32>(MintTx::VT_GAS_SPONSORER, gas_sponsorer);
  }
  #[inline]
...
impl<'a> StakeTx<'a> {
  ...
  pub fn delegation_receiver(&self) -> Option<&'a Bytes32> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<Bytes32>(StakeTx::VT_DELEGATION_RECEIVER, None)}
  }
  #[inline]
  pub fn amount(&self) -> u64 {
    // Safety:
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> StakeTxBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_sender(&mut self, sender: &Bytes32) {
    self.fbb_.push_slot_always::<&Bytes32>(StakeTx::VT_SENDER, sender);
  }
  #[inline]
  pub fn add_delegation_receiver(&mut self, delegation_receiver: &Bytes32) {
    self.fbb_.push_slot_always::<&Bytes32>(StakeTx::VT_DELEGATION_RECEIVER, delegation_receiver);
  }
  #[inline]
  pub fn add_amount(&mut self, amount: u64) {
  ...
  #[inline]
  pub fn add_signature(&mut self, signature: &Bytes64) {
    self.fbb_.push_slot_always::<&Bytes64>(StakeTx::VT_SIGNATURE, signature);
  }
  #[inline]
  pub fn add_gas_sponsorer(&mut self, gas_sponsorer: &Bytes32) {
    self.fbb_.push_slot_always::<&Bytes32>(StakeTx::VT_GAS_SPONSORER, gas_sponsorer);
  }
  #[inline]
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> SolveTxBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_sender(&mut self, sender: &Bytes32) {
    self.fbb_.push_slot_always::<&Bytes32>(SolveTx::VT_SENDER, sender);
  }
  #[inline]
  pub fn add_proof(&mut self, proof: &Bytes256) {
    self.fbb_.push_slot_always::<&Bytes256>(SolveTx::VT_PROOF, proof);
  }
  #[inline]
  pub fn add_puzzle_id(&mut self, puzzle_id: &Bytes32) {
    self.fbb_.push_slot_always::<&Bytes32>(SolveTx::VT_PUZZLE_ID, puzzle_id);
  }
  #[inline]
  pub fn add_nonce(&mut self, nonce: u64) {
  ...
  #[inline]
  pub fn add_signature(&mut self, signature: &Bytes64) {
    self.fbb_.push_slot_always::<&Bytes64>(SolveTx::VT_SIGNATURE, signature);
  }
  #[inline]
  pub fn add_gas_sponsorer(&mut self, gas_sponsorer: &Bytes32) {
    self.fbb_.push_slot_always::<&Bytes32>(SolveTx::VT_GAS_SPONSORER, gas_sponsorer);
  }
  #[inline]
...
impl<'a> SealedTx<'a> {
  ...
  #[inline]
  pub fn nonce(&self) -> Option<&'a Nonce96> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<Nonce96>(SealedTx::VT_NONCE, None)}
  }
  #[inline]
  pub fn tag(&self) -> Option<&'a Tag128> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<Tag128>(SealedTx::VT_TAG, None)}
  }
  #[inline]
  pub fn ciphertext(&self) -> flatbuffers::Vector<'a, u8> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(SealedTx::VT_CIPHERTEXT, None).unwrap()}
  }
}
...
impl flatbuffers::Verifiable for SealedTx<'_> {
  ...
  fn run_verifier(
    ...
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<Nonce96>("nonce", Self::VT_NONCE, false)?
     .visit_field::<Tag128>("tag", Self::VT_TAG, false)?
...
pub struct SealedTxArgs<'a> {
    pub nonce: Option<&'a Nonce96>,
    pub tag: Option<&'a Tag128>,
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> SealedTxBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_nonce(&mut self, nonce: &Nonce96) {
    self.fbb_.push_slot_always::<&Nonce96>(SealedTx::VT_NONCE, nonce);
  }
  #[inline]
  pub fn add_tag(&mut self, tag: &Tag128) {
    self.fbb_.push_slot_always::<&Tag128>(SealedTx::VT_TAG, tag);
  }
  #[inline]
  ...
  pub fn finish(self) -> flatbuffers::WIPOffset<SealedTx<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, SealedTx::VT_CIPHERTEXT,"ciphertext");
    flatbuffers::WIPOffset::new(o.value())
  }
}
